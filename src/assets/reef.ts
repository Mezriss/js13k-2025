...
const stone = new SvgAsset(
  `M-7.7 6.4C-7.5 5.3-7.6 3.8-6.9 2.2-6.3.7-3.8-5.4-3.5-5.6-3.3-5.8-3-5.7-2.9-5.8-2.6-5.8-2.5-4.4-2.4-4.6-2.3-4.7-1.6-7.1-1.2-7.1-.7-7.1-1.1-7.1-.7-7.1-.5-7.1-.3-6.4-.1-6.3.1-6.3.4-8 1-8 1.5-8 1-8 1.6-8 2.1-8.1 2.3-6.6 2.7-6.4 3.2-6.3 3.2-6.5 3.5-6.4 3.7-6.3 4.4-1.8 4.6-1.6 4.8-1.3 4.9-1.6 5.1-1.3 5.3-1 6.9 6 6.9 6.2 6.9 6.4-7.7 6.4-7.7 6.4Z
...
`,
  ["#2a1e16", , , , , , , "#727a4f"],
  [[0, "#cbab83", 0.55, "#67564d", 0.75, "#40302f"], , , , , , , "#848c60"],
);
